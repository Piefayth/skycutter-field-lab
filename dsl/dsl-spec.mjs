...
export const MODIFIERS = [
  ...
  { name: "particles", signature: "particles advect=VEC2_FIELD [count=N] [length=N] [speed=N] [fade=N] [color [R,G,B]]", doc: "Optional sibling clause inside a `view` block. Renders deterministic tracer particles advected through a vec2 tangent field, with fading trails. Render-only: it never writes simulation state." },
