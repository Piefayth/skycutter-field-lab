...
export const MODIFIERS = [
  ...
  { name: "size",     signature: "glyph ... size=SCALAR_FIELD / particles ... size=N", doc: "Optional named arg on `glyph` and `particles`. Glyph: scalar field that multiplies glyph size per cell. Particles: screen-space point size in pixels, default 6." },
