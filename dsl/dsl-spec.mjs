...
export const MODIFIERS = [
  ...
  { name: "size",     signature: "glyph ... size=SCALAR_FIELD / particles ... size=N", doc: "Optional named arg on `glyph` and `particles`. Glyph: scalar field that multiplies glyph size per cell. Particles: visual tracer size on the globe surface, default 4." },
