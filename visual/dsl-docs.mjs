...
const CATEGORY_HINTS = {
  ...
  "Action verbs (cell/event/each)": "Statements inside per-cell bodies — set / add / let / when.",
  "Init verbs (presets/stamps)": "Statements inside scenario / stamp bodies — spot, ellipse, region, for each cell.",
  "Pipeline primitives": "Stage-level primitives kept in v2 — `advect` (semi-Lagrangian sample), `wind` (gradient + tangent frame).",
