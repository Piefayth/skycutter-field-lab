...
const CATEGORY_HINTS = {
  ...
  "Schema declarations": "Declare what state and inputs the recipe owns.",
  "Block forms": "Stages, presets, stamps — the body shapes.",
  "Stage I/O": "Lists of fields a stage reads, writes, or declares.",
  "Control flow": "Per-cell math blocks and conditional branches.",
  "Action verbs (cell/event/each)": "Statements inside per-cell bodies.",
  "Init verbs (presets/stamps)": "Statements inside preset / stamp bodies.",
  "Pipeline primitives": "Stage-level primitives — wind, advect, diffuse, ...",
  "Math functions": "Callable in any expression after `use core ...`.",
  "Math constants": "Compile-time numeric constants.",
  "Time builtins": "dt and frame for time-dependent math.",
  "Geodesic position builtins": "Per-cell longitude / latitude / unit-sphere coords.",
  "Grid declaration": "Substrate definition.",
  "Param modifiers": "Trailing keywords on `param` / `setting` declarations.",
  "Stamp/spot modifiers": "Trailing keywords on init verbs and primitives.",
